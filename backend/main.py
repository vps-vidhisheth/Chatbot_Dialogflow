...
async def handle_request(request: Request):
    ...
    # Print the received intent for debugging
    ...
    # Use get to avoid KeyError if intent is not found
...
def track_order(parameters: dict, session_id: str):
    # Ensure you are accessing the correct parameter
    order_id = int(parameters.get('order_id', parameters.get('number', 0)))  # Fallback to 0 if not found
